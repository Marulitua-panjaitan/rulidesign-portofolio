    ...
    <section className="min-h-screen pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="group relative p-8 rounded-[2.5rem] bg-white/[0.03] border border-white/5 hover:border-blue-500/30 transition-all duration-500 overflow-hidden flex flex-col"
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-2xl font-bold mb-2 group-hover:text-blue-400 transition-colors">{service.title}</h3>
                <p className="text-blue-500 font-mono text-sm mb-6">{service.price}</p>
             ...
             <button 
                ...
                className="w-full py-4 bg-white/5 hover:bg-blue-600 ...">
                Pesan Sekarang
                </button>
              </div>
            </motion.div>
        ...
        <motion.div 
          ...
          className="mt-20 p-10 rounded-[3rem] bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-white/5 text-center"
        >
          <p className="text-gray-400 font-mono text-sm mb-4 italic">"Kualitas industri, harga kompetitif."</p>
          <h3 className="text-2xl font-bold text-white">Butuh konsultasi gratis? Hubungi saya di Fastwork atau WhatsApp.</h3>
        </motion.div>
      </div>
    </section>
  );
